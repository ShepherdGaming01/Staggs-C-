...
*/
    ...
    //*p_number3 = 33;  //Writting into a pointer pointing nowhere: BAD, will crash!!
...
/*
    ...
    After this line executes, we will have a valid memeory location
...
*/
    *p_number4 = 77; //Writting into dynamically allocated memory
    ...
    std::cout << "p_number5 new: " << *p_number5 << std::endl;
